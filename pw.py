...
2:initialize table, i.e. delete all passwords, and encrypt to disk 
3:change password
"""
)
iop = eval(tmp)
if iop == 3:
    pwdData = decryptFromDisk()
    changePassword()
    key, hexkey = getKeyNewPwd(pwd)
    encryptToDisk(pwdData)
elif iop == 2:
    data = {}  # empty table
    encryptToDisk(data)
elif iop == 1:
